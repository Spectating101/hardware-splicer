...
import { Zap, Code, Terminal, BookOpen, ArrowRight, Copy, Check, ExternalLink, Key, Database, Cpu } from 'lucide-react';
...
for component in result.components:
  ...
  const javascriptExample = `import CircuitAI from 'circuit-ai-sdk';
...
result.components.forEach(component => {
  console.log(\`- \${component.name}: \${component.confidence.toFixed(2)}\`);
});`;
