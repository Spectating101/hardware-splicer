...
**Tier III status (2026-07-07):** ✅ `make verify-product-internal` PASS on **desktop-fgedhgv** (WSL2 Ubuntu 24.04) — see [`INSTALL_REPORT_desktop-fgedhgv-wsl_2026-07-07.md`](install_reports/INSTALL_REPORT_desktop-fgedhgv-wsl_2026-07-07.md). Dev-linux report: [`INSTALL_REPORT_dev-linux_2026-07-06.md`](install_reports/INSTALL_REPORT_dev-linux_2026-07-06.md).
