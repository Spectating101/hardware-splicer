# Hardware-Splicer — Research Access & Resource Conversion Lane (2026 Q3)
...
Hardware-Splicer is now better positioned for external-resource conversion than for generic feature expansion. The current software/MCP architecture and adversarial evaluation infrastructure are already sufficient to support credible research questions, while the main missing tranche is still external evidence: live-model execution, fresh revision-bound physical proof and independent operator evidence.

The aim here is therefore:

> **one evidence core → multiple research/resource verdicts → external receipts → stronger next applications.**
...
- a live external model has passed the frozen ten-case corpus;
- fresh SPI physical correctness is closed;
