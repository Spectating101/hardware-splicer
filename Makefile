...
test-splice-product-v1:
	PYTHONPATH=src $(PYTHON) -m pytest tests/test_splice_product_v1.py tests/test_design_studio_agent.py tests/test_canvas_module_pins.py tests/test_compose_agent_loop_salvage.py tests/test_compose_bench_loop.py -q
