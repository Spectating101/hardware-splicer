/** Minimal ZIP (store only, no compression) for browser firmware bundles. */
...
/** Build a ZIP archive from path → utf8 content. */
export function buildZipStore(files: Record<string, string>): Blob {
